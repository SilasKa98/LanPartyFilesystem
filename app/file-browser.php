...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .brand { display:flex; align-items:center; gap:10px; text-decoration:none; color:inherit; } .brand-subtitle{white-space:nowrap;}
...
<div class="app-shell"><aside class="sidebar"><a href="index.php" class="brand" style="margin-bottom:14px"><img src="../media/LocalLoot_logo.png" class="brand-logo" alt="LocalLoot Logo"><div><h1 style="font-size:1.2rem">LocalLoot</h1><div class="brand-subtitle" style="color:#6d7f9d;">Local Tools for LAN-Parties</div></div></a><div style="margin-top:16px;color:#7e8eaa;font-size:.85rem;">MODULES</div><a class="side-link active" href="file-browser.php">📁 Files</a><a class="side-link" href="#">🎮 Game Library</a><a class="side-link" href="chat.php">💬 Chat</a><a class="side-link" href="#">🧰 Tools</a><div class="side-tools"><div class="search-wrap"><input id="searchInput" class="input" placeholder="Dateien/Ordner global suchen" oninput="filterEntriesDebounced();searchAllPaths()"><div id="searchResults" class="search-results"></div></div><select id="sortSelect" class="input" onchange="sortEntries()"><option value="nameAsc">Name A-Z</option><option value="nameDesc">Name Z-A</option></select><button id="viewToggle" class="btn" onclick="toggleView()" aria-pressed="false">☰ List View</button><button id="myBtn" class="btn" type="button">+ New Folder</button><button id="copyPathBtn" class="btn" onclick="copyCurrentPath()">⎘ Pfad kopieren</button></div></aside><main><div id="content">

...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        h1 { margin:0; font-size: 1.2rem; letter-spacing: .01em; text-shadow: 0 0 10px rgba(34, 198, 255, .28); font-weight:700; }

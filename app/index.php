...
<div id="content">
    <div class="topbar"><h1>Lan Cloud</h1><div class="toolbar"><input id="searchInput" class="input" placeholder="Search files/folders" oninput="filterEntries()"><button id="copyPathBtn" class="btn" onclick="copyCurrentPath()">Copy Path</button></div></div>
    ...
    foreach($scanned_directory as $entry){
        if(strpos($entry, ".") === false){
            ...
            echo "<a href='".$_SERVER['REQUEST_URI'].($cntPath == 0 ? "?" : "&")."Pfad".$cntPath."=".$entry."'><img src='../media/folder-open.svg'></a>";
    ...
    foreach($scanned_directory as $entry){
        if(strpos($entry, ".") !== false){
            ...
            echo "<div class='card' data-name='".$entry."' oncontextmenu='openDropdown(this)'><img src='".$media."'>";
            echo '<div class="dropdown-content">';
